        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 flex items-center bg-white/10 border border-white/20 px-3 py-2 rounded-lg">
            ...
            <input
              ...
              onChange={(e) => setQuery(e.target.value)}
              placeholder="Search questions..."
              className="ml-2 bg-transparent outline-none text-sm flex-1 text-white"
            />
          </div>
        </div>
      </div>
        ...
        {!loading &&
          results.map((q) => (
            <div
              ...
              className="bg-white/5 border border-white/10 rounded-xl p-4 mb-3 cursor-pointer hover:bg-white/10"
            >
